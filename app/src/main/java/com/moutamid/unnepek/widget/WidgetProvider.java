...
public class WidgetProvider extends AppWidgetProvider {
        ...
        switch (intent.getAction()) {
            ...
            case ACTION_CURRENT_DAY:
                ...
                AppWidgetManager.getInstance(context).notifyAppWidgetViewDataChanged(
                        AppWidgetManager.getInstance(context).getAppWidgetIds(widget),
                        R.id.calendarGrid
                );
                break;
            ...
            case ACTION_CELL_CLICK:
                ...
                Intent intent1 = new Intent(context, MonthlyViewActivity.class);
    ...
    public static void updateAppWidget(Context context, AppWidgetManager manager, int appWidgetId) {
        ...
        PendingIntent currentDayPending = PendingIntent.getBroadcast(context, appWidgetId + 1, currentDayIntent,
                PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        views.setOnClickPendingIntent(R.id.currentDayBtn, currentDayPending);
        views.setOnClickPendingIntent(R.id.currentDay, currentDayPending);

        // Next Month
        Intent nextIntent = new Intent(context, WidgetProvider.class);
        nextIntent.setAction(ACTION_NEXT);
        nextIntent.setData(Uri.parse("widget://next" + appWidgetId));
        PendingIntent nextPending = PendingIntent.getBroadcast(context, appWidgetId + 2, nextIntent,
                PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        ...
        PendingIntent openPending = PendingIntent.getActivity(context, appWidgetId + 3, openIntent,
                PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        ...
        // Broadcast for each grid cell click
        Intent clickIntentTemplate = new Intent(context, WidgetProvider.class);
        clickIntentTemplate.setAction(ACTION_CELL_CLICK);
